<script>
  ...
  import TrendsSidebar from "../components/task-manager/sidebars/TrendsSidebar.svelte";
  import NavSidebar from "../components/task-manager/sidebars/NavSidebar.svelte";
</script>
